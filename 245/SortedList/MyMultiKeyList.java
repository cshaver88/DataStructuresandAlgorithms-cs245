...
//			}
    ...
    // within the range of allowed keys, throw an IllegalArgumentException
	public Link get(int index, int keyIndex) { //index == num used to iterate through the list keyIndex ==  apple banana...
	...
	@Override
    // Remove the element matching the key at the given index         key is apple and keyIndex is 0
	...
	private class MyIterator implements MultiKeyListIterator {
		...
		public MyIterator (int index, int key){  //index is the key in which to iterate over num now has no use    case 1 call next case 2 call previous case 3 call delete after next and case4 call delete after previous
